        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50" onClick={handleBackdropClick}>
            ...
            >
                ...
                <div className="flex items-center justify-between p-4 md:p-6 border-b border-gray-700">
                    <h2 className="text-xl md:text-2xl font-bold text-emerald-300">Edit Category</h2>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-4">
                    ...
                    {/* Category Info */}
                    {category && (
                        <div className="bg-gray-700 p-3 rounded-lg text-sm border border-gray-600">
                            <p className="text-gray-300">
                                <span className="font-medium text-emerald-300">Slug:</span> {category.slug}
                            </p>
                            <p className="text-gray-300">
                                <span className="font-medium text-emerald-300">Created:</span> {new Date(category.createdAt).toLocaleDateString()}
                            </p>
                            <p className="text-gray-300">
                                <span className="font-medium text-emerald-300">Last Updated:</span> {new Date(category.updatedAt).toLocaleDateString()}
                            </p>
                        </div>
                    )}
