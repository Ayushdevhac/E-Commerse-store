		...
		>
            ...
            px-5 py-2.5 text-sm font-medium text-white hover:bg-red-700 focus:outline-none
             focus:ring-4 focus:ring-red-300'
				...
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-gray-300'>Your Available Coupon:</h3>					<div className='mt-2 text-sm text-gray-400'>
						<p><strong>{coupon.code}</strong> - {coupon.discountPercentage}% off</p>
						{coupon.minimumAmount > 0 && (
							<p className='text-xs text-gray-500 mt-1'>
								Minimum order: ${coupon.minimumAmount} 
								{subtotal >= coupon.minimumAmount ? 
									<span className='text-green-400 ml-1'>✓ Eligible</span> : 
									<span className='text-yellow-400 ml-1'>
										(Need ${(coupon.minimumAmount - subtotal).toFixed(2)} more)
									</span>
								}
							</p>
						)}
